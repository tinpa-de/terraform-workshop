...
# Vorgefertigter Lambda Layer für psycopg2 (Postgres-Client)
# AWS Klayers project bietet öffentliche Layer für gängige Python-Pakete
locals {
  # eu-central-1, python3.12, psycopg2-binary
